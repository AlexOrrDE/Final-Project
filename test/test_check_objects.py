...
def test_should_return_True_if_more_than_one_object_is_in_the_bucket(s3_client):
    ...
    s3_client.put_object(Bucket='marble-test-bucket', Key='2023-01-01 00:00:00.000000-test-table.csv')
    s3_client.put_object(Bucket='marble-test-bucket', Key='2023-01-01 01:00:00.000000-test-table.csv')

    assert check_objects() == True

def test_should_raise_client_error_to_be_handled_in_handler_if_target_bucket_does_not_exist(s3_client):
