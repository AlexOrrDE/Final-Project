...
def test_should_accept_a_filetype_in_the_form_returned_by_get_table_data():
    """filetype returned by get_table_data is a dictionary with 2 key value pairs, representing the table_name and a list of dictionaries of data"""
    input = {
        'table_name': 'staff', 
        'data': [{
            'staff_id': 1, 'first_name': 'Jeremie', 'last_name': 'Franey', 'department_id': 2, 'email_address': 'jeremie.franey@terrifictotes.com', 'created_at': Timestamp('2022-11-03 14:20:51.563000'), 'last_updated': Timestamp('2022-11-03 14:20:51.563000')
        }]
    }
