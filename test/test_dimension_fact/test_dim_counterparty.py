...
columns = ['counterparty_id', 'counterparty_legal_name', 'legal_address_id', 'commercial_contact', 'delivery_contact', 'created_at', 'last_updated', 'address_id', 'address_line_1', 'address_line_2', 'district', 'city', 'postal_code', 'country', 'phone', 'created_at', 'last_updated']

values = [[7, 'Padberg, Lueilwitz and Johnson', 16, 'Ms. Wilma Witting', "Christy O'Hara", '2022-11-03 14:20:51.563', '2022-11-03 14:20:51.563', 16, '511 Orin Extension', 'Cielo Radial', 'Buckinghamshire', 'South Wyatt', '04524-5341', 'Iceland', '2372 180716', '2022-11-03 14:20:49.962', '2022-11-03 14:20:49.962']]

# # list with nan values
values2 = [[1, 'Fahey and Sons', 15, 'Micheal Toy', 'Mrs. Lucy Runolfsdottir', '2022-11-03 14:20:51.563', '2022-11-03 14:20:51.563', 15, '605 Haskell Trafficway', 'Axel Freeway', "nan", 'East Bobbie', '88253-4257', 'Heard Island and McDonald Islands', '9687 937447', '2022-11-03 14:20:49.962', '2022-11-03 14:20:49.962']]
...
def test_should_raise_key_error_if_given_incorrect_dataframe():
    with raises(KeyError):
        incorrect_values = [[8, '2022-11-03 14:20:49.962', 'Wooden', '/usr', 'wooden-20220717-npgz.json', '2022-11-03 14:20:49.962']]
