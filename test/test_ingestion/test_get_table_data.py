...
class FullMock:
    class cursor:
        ...
        description = [
            ("staff_id", 23, None, None, None, None, None),
            ("first_name", 25, None, None, None, None, None),
            ("last_name", 25, None, None, None, None, None),
            ("department_id", 23, None, None, None, None, None),
            ("email_address", 25, None, None, None, None, None),
            ("created_at", 1114, None, None, None, None, None),
            ("last_updated", 1114, None, None, None, None, None),
        ]
...
def test_should_return_False_when_no_updates_are_found():
    ...
    assert (
        fetch_data_from_tables(MockConn,
                               "staff",
    ...
    expected = {
        ...
        "data": [
            ...
            },
            {
                ...
                "created_at": Timestamp("2024-11-03 14:20:51.563000"),
                "last_updated": Timestamp("2024-11-03 14:20:51.563000"),
            },
        ],
    }

    assert fetch_data_from_tables(FullMock, "staff") == expected
...
def test_should_return_updates_if_table_has_been_updated():
            ...
            def fetchall(self):
                return (
                    [
                        ...
                        "flavio.kulas@terrifictotes.com",
                        datetime.datetime(2022, 11, 3, 14, 20, 51, 563000),
                        datetime.datetime(2023, 11, 6, 14, 20, 51, 563000),
                    ],
                    [
                        1,
                        "Jeremie",
        ...
        "data": [
            {
                ...
                "email_address": "flavio.kulas@terrifictotes.com",
                "created_at": Timestamp("2022-11-03 14:20:51.563000"),
                "last_updated": Timestamp("2023-11-06 14:20:51.563000"),
            },
            {
                "staff_id": 1,
                "first_name": "Jeremie",
    ...
    assert fetch_data_from_tables(MockConn,
                                  "staff",
                                  "2023-11-06 12:00:00") == expected
...
def test_should_raise_database_error_to_be_handled_in_handler(caplog):
    ...
    with pytest.raises(DatabaseError):
        ...
        assert (
            "Error occured in fetch_data_from_tables, calling table staff"
            in caplog.text
        )
