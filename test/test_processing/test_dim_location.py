...
def create_address_data():
    data = {'address_id': [1, 2],
            'address_line_1': ['test_address_1',
                               'test_address_2'],
            'address_line_2': ['test_second_address_1',
                               'test_second_address_2'],
            'district': ['test_dist_1',
                         'test_dict_2'],
            'city': ['test_city_1',
                     'test_city_2'],
            'postal_code': ['test_postal_1',
                            'test_postal_2'],
...
def test_dim_design_doesnt_change_data_in_columns_it_keeps(
        create_address_data):
    transformed_data = create_dim_location(create_address_data)
